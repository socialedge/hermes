...
public class ExceptionSpecification implements Serializable {
    ...
    public ExceptionSpecification(URI source, String title, Integer httpStatus, String detail, URL help) {
    ...
    public ExceptionSpecification(String source, String title, Integer httpStatus, String detail, String
            help) {
        this(uri(source), title, httpStatus, detail, isNotBlank(help) ? url(help) : null);
    }

    public ExceptionSpecification(URI source, String title, Integer httpStatus, String detail) {
        this(source, title, httpStatus, detail, null);
    }

    public ExceptionSpecification(String source, String title, Integer httpStatus, String detail) {
        this(uri(source), title, httpStatus, detail);
    }

    public ExceptionSpecification(URI source, String title, Integer httpStatus) {
        this(source, title, httpStatus, null, null);
    }

    public ExceptionSpecification(String source, String title, Integer httpStatus) {
