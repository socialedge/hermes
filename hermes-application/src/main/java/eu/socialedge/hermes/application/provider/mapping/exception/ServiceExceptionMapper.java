...
@Provider
public class ServiceExceptionMapper extends DefaultLoggingExceptionMapper<Exception> {

    protected ServiceExceptionMapper(@Context HttpServletRequest httpRequest) {
        super(httpRequest);
    }
}
